...
net = Deeplab_v3plus.DeepLabv3_plus(n_InputChannels=3, n_classes=cfg.DATASET[1], os=16, _print=False).to(device)
net.load_state_dict(t.load('./Results/weights/FCN_weight/48.pth'))
net.eval()
...
for i, sample in enumerate(test_data):
	...
	pre1.save(dir + str(i).zfill(3) + '.png')
	print('Done')